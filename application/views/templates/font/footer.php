            ...
            <div class="row">
                <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                    <div class="footer-widget footer-about-widget">
                        <div class="footer-logo">
                            <div class="site-logo">
                                <img src="<?= base_url() ?>assets/fontoffice/img/logo.png" alt="Logo">
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-md-6 col-sm-12 col-12">
                    <div class="footer-widget footer-newsletter-widget">
                        ...
                        <img src="<?= base_url() ?>assets/fontoffice/img/icons/payment-4.png" alt="Payment Image">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                    <div class="modal-product-img">
                                        <img src="<?= base_url() ?>assets/fontoffice/img/product/4.png" alt="#">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                    ...
                    <div class="ltn__quick-view-modal-inner">
                        <div class="modal-product-item">
                            <div class="row">
                                <div class="col-12">
                                    <div class="modal-product-img">
                                        <img src="<?= base_url() ?>assets/fontoffice/img/product/1.png" alt="#">
                                    </div>
                                    <div class="modal-product-info">
                                        <h5><a href="" id="addcart_name"></a></h5>
                                        <p class="added-cart"><i class="fa fa-check-circle"></i> Ajouté avec succès à votre panier</p>
                                        <div class="btn-wrapper">
                                            <a href="<?= base_url(); ?>mycart" class="theme-btn-1 btn btn-effect-1">Mon Panier</a>
                                    ...
                                    <!-- <div class="additional-info d-none---">
                                        ...
                                        <div class="payment-method">
                                            <img src="<?= base_url() ?>assets/fontoffice/img/icons/payment.png" alt="#">
                                        </div>
                                    </div> -->
                                </div>
                            </div>
                    ...
                    <div class="ltn__quick-view-modal-inner">
                        <div class="modal-product-item">
                            <div class="row">
                                <div class="col-12">
                                    <div class="modal-product-img">
                                        <img src="<?= base_url() ?>assets/fontoffice/img/product/7.png" alt="#">
                                    </div>
                                    <div class="modal-product-info">
...
<!-- Mirrored from tunatheme.com/tf/html/broccoli-preview/broccoli/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Nov 2021 13:08:08 GMT -->
